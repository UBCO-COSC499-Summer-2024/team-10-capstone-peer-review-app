			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				<div className="lg:col-span-2">
					...
					<Card className="bg-white p-4 shadow-md mb-6">
						<CardHeader className="flex justify-between items-center">
							<CardTitle className="text-lg font-bold">
								Peer Review Document 1
							</CardTitle>
							<Button variant="outline">download</Button>
						</CardHeader>
						<CardContent className="bg-gray-100 p-4 rounded relative">
							<div
								className={`bg-white border border-gray-200 overflow-hidden transition-all duration-300 ${expanded.box1 ? "h-64" : "h-32"}`}
							>
								{/* Preview content */}
								<p className="text-gray-500 p-2">
									This is a preview of the peer-review document.
								</p>
							</div>
					...
					<Card className="bg-white p-4 shadow-md mb-6">
						...
						<CardContent className="bg-gray-100 p-4 rounded relative">
							<div
								className={`bg-white border border-gray-200 overflow-hidden transition-all duration-300 ${expanded.box2 ? "h-64" : "h-32"}`}
							>
								{/* Preview content */}
								<p className="text-gray-500 p-2">
									This is a preview of the peer-review document.
