...
const Class = () => {
	...
	const classAssignments = assignmentsData.filter(
		(assignment) => assignment.className === classItem.name
	);
	const categories = [
		...new Set(classAssignments.map((assignment) => assignment.category))
	];
				...
				<div className="flex rounded-lg">
					<div className="flex justify-between items-center">
						<Menubar>
							<MenubarMenu>
								<MenubarTrigger
									className="border border-gray-600 rounded-lg hover:bg-gray-300"
