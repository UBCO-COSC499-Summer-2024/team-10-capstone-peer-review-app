...
const AssignedPR = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="text-sm text-gray-500">Peer Reviews Done: {assignment.peerReviewsDone}</div>
      <div className="text-sm text-gray-500">Peer Review Due Date: {assignment.peerReviewDueDate}</div>
      <div className="text-sm text-gray-500">For Review: {assignment.forReview ? 'Yes' : 'No'}</div>
    </div>
  );
};
