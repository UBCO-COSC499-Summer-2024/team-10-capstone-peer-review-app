    ...
    if (infoStep === 1) {
      return (
        <DialogContent className="z-50">
          ...
          <DialogDescription>
            <p className="mb-2">The Reviews page allows you to manage and view your peer reviews:</p>
            <ul className="list-disc list-inside mb-4">
              <li>Reviews Received: View feedback on your submissions</li>
              <li>Reviews Assigned: Complete reviews for other students' work</li>
            </ul>
      ...
      return (
        <DialogContent className="z-50">
          ...
          <DialogDescription>
            <p className="mb-2">Here's how to use the Reviews page effectively:</p>
            <ul className="list-disc list-inside mb-4">
              <li>Click on a review to view its details</li>
              <li>For assigned reviews, you can edit and submit your feedback</li>
              <li>For received reviews, you can see comments and grades from your peers</li>
              <li>Use the search and filter options to find specific reviews</li>
            </ul>
            <p>Remember to complete your assigned reviews before their due dates!</p>
          </DialogDescription>
          <DialogFooter>
            <Button onClick={() => {
