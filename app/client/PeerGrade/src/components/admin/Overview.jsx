...
import { UsersIcon, AcademicCapIcon, DocumentTextIcon, ChatBubbleLeftRightIcon, CheckCircleIcon, XCircleIcon } from '@heroicons/react/24/outline';
...
const instructorsData = [
  { id: 1, name: "Prof. John Doe", status: "Active", dateJoined: "2020-09-01", classes: 3 },
  { id: 2, name: "Dr. Jane Smith", status: "Inactive", dateJoined: "2019-11-05", classes: 2 },
  // Add more instructor data here...
];

const instructorApprovalsData = [
  { id: 1, name: "Prof. Pending Approval", status: "Pending", dateJoined: "2023-01-01" },
    ...
    { accessorKey: 'dateJoined', header: 'Date Joined' },
    {
      ...
      cell: ({ row }) => (
        <div className="flex justify-around">
          <Button variant="ghost" size="icon" onClick={() => handleApprove(row.original)}>
            <CheckCircleIcon className="w-4 h-4" />
          </Button>
          <Button variant="ghost" size="icon" onClick={() => handleReject(row.original)}>
        ...
        <div className="flex flex-col w-full ">
          <Tabs defaultValue="students">
            ...
            <TabsContent value="instructors">
              <div className="mb-6 pt-3 bg-white">
                <DataTable title="Instructors" data={instructorsData} columns={instructorColumns} pageSize={5} enableStatus={true} />
              </div>
            </TabsContent>
