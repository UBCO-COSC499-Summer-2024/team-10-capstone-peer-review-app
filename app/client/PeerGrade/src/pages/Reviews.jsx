        ...
        return (
          <Card key={item.submissionId} className="w-full bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-semibold text-primary">Assignment ID: {item.assignmentId}</CardTitle>
              <CardDescription className="text-sm text-slate-500">
                Submission ID: {item.submissionId}
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <p className="text-sm text-slate-600 mb-4">File: {item.submissionFilePath}</p>
            ...
            <CardFooter className="pt-4">
              <Link to={`/submission/${item.submissionId}`} className="w-full">
