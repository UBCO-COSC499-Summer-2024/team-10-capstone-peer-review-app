...
const AssignedPR = () => {
	...
	const calculateGradePercentage = (review) => {
		if (!review || !review.criterionGrades || !review.submission || !review.submission.assignment || !review.submission.assignment.rubric) {
		...
		if (Array.isArray(rubric)) {
			totalMaxPoints = rubric.reduce((total, r) => total + (r.totalMarks || 0), 0);
											...
											<Progress
												value={
													criterionGrade.criterion?.maxMark
														? (criterionGrade.grade / criterionGrade.criterion.maxMark) * 100
														: 0
												}
												className="h-2 mb-2"
											/>
