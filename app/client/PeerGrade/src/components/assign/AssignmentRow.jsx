...
function AssignmentRow({ id, name, className, dueDate, peerReviewDueDate, forReview }) {
  ...
  return (
    <div className="flex items-center gap-5 p-2 justify-between ">
      ...
      <div className="flex items-center justify-center">
        <div className="text-sm text-gray-500 "><p className='p-4 bg-red-100 rounded-full'>{displayDate}</p></div>
        <Link to={link}>
