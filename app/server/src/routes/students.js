...
router.route("/get-assignment").post(ensureUser, ensureStudent, getAssignment);

router
	.route("/get-class-assignment")
...
router
	.route("/update-group-info")
	.post(ensureUser, ensureStudent, updateGroupInClass);

router.route("/get-group").post(ensureUser, ensureStudent, getGroupInClass);

router.route("/get-groups").post(ensureUser, ensureStudent, getGroupsInClass);

router
	.route("/get-group-members")
	.post(ensureUser, ensureStudent, getGroupMembers);

router.route("/:classId").get(ensureUser, ensureStudent, getClassById);
