        ...
        <TabsContent value="profile">
          <Card className="flex flex-col lg:flex-row gap-4 bg-gray-100 p-4 mb-6 rounded-lg">
            <div className="flex flex-col items-center lg:items-start lg:w-1/3">
              ...
              <h2 className="text-lg font-semibold mt-4">Test user</h2>
              <p className="text-gray-500">Profile description goes here</p>
            </div>
            <div className="lg:w-2/3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input type="email" placeholder="Select a verified email to display" />
                ...
                <div>
                  ...
                  <Input type="url" placeholder="https://shadcn.com" className="mb-2" />
                  <Input type="url" placeholder="https://twitter.com/shadcn" />
