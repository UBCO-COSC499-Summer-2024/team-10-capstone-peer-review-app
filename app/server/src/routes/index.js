...
import review2Router from "./review2.js";
import groupReviewRouter from "./groupReview.js";
...
router.use("/review2", review2Router);
router.use("/groupReview", groupReviewRouter);
